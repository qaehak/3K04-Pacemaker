...
print("Ventrical Amplitude: " + str(parameters.get_VentricalAmplitude()))
print("Ventrical Pulse Width: " + str(parameters.get_VentricalPulseWidth()))
...
parameters.set_VentricalAmplitude(16)
parameters.set_VentricalPulseWidth(15)
...
parameters.set_VentricalAmplitude(5)
parameters.set_VentricalPulseWidth(6)
